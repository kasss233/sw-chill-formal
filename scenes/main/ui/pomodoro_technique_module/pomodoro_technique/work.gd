...
@onready var work_times_text = $times/VBoxContainer/work_times_text;
...
func flush_times_text() -> void:
	work_times_text.text = str(times)
	pass

func _on_work_times_add_pressed() -> void:
...
func _on_work_times_minus_pressed() -> void:
