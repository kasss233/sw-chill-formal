...
## Adjusts the brightness of cirrus clouds at night.
@export var cirrus_intensity_night: float = 1.0:
	set(value):
		cirrus_intensity_night = value
		if is_scene_built:
			sky_material.set_shader_parameter("cirrus_intensity_night", cirrus_intensity_night)
